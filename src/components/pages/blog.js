...
export default class Blog extends Component {
    ...
    getBlogItems(){
        ...
        axios.get(`https://tristanmouritsen.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`, {withCredentials: true})
        .then(response => {
            this.setState({
        ...
        const blogRecords=this.state.blogItems.map(blogItem => {
            if (this.props.loggedInStatus ===  "LOGGED_IN") {
                ...
                <div key={blogItem.id} className="admin-blog-wrapper">
                    <a className="blog-delete" onClick={() => this.handleDeleteClick(blogItem)} ><FontAwesomeIcon icon="trash" /></a>
